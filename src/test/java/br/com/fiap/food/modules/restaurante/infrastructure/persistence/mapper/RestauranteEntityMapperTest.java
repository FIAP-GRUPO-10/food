...
class RestauranteEntityMapperTest {
    ...
    @BeforeEach
    void setUp() {
        TipoUsuarioEntityMapper tipoUsuarioMapper = Mappers.getMapper(TipoUsuarioEntityMapper.class);
        UsuarioEntityMapper usuarioMapper = Mappers.getMapper(UsuarioEntityMapper.class);
        ReflectionTestUtils.setField(usuarioMapper, "tipoUsuarioEntityMapper", tipoUsuarioMapper);
